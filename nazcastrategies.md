...
![nazca_model](https://github.com/NazcaBot/nazcawiki/blob/master/nazca_model.png)
...
![nazca_assets](https://github.com/NazcaBot/nazcawiki/blob/master/nazca_assets.png)
...
![nazca_backtest](https://github.com/NazcaBot/nazcawiki/blob/master/nazca_backtest.png)
...
![nazca_backtest_dates](https://github.com/NazcaBot/nazcawiki/blob/master/nazca_bt_dates.png)
...
![nazca_goback](https://github.com/NazcaBot/nazcawiki/blob/master/nazca_goback.png)
***
...
![nazca_api](https://github.com/NazcaBot/nazcawiki/blob/master/nazca_api.png)
...
![nazca_execute](https://github.com/NazcaBot/nazcawiki/blob/master/nazca_execute.png)
...
![nazca_payent](https://github.com/NazcaBot/nazcawiki/blob/master/nazc_payment.png)

***

## Congratulations! Your strategy has been executed and you can now follow its progress from the **Dashboard**.

![nazca_dashboard](https://github.com/NazcaBot/nazcawiki/blob/master/dashb.png)
...
![nazca_pause](https://github.com/NazcaBot/nazcawiki/blob/master/nazca_pause.png)

2. **Edit** - _edit your strategy and go back to the Wizard_

3. **Rebalance Now** - _trigger a manual rebalance at any moment_

![nazca_rebalance](https://github.com/NazcaBot/nazcawiki/blob/master/nazca_rebalance.png)
